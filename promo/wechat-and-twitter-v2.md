...
找个现成的小工具，你是不是也习惯搜一下、挑个排在前面的、装上就完事？我一直这么干，直到上礼拜差点栽一次。那回我才发现，排第一的那个，未必适合我这种用法。

前几天我想把一个 YouTube 视频转成文字。视频有点长，自己边听边记太累，就想找个现成的。这回我没自己翻 GitHub，让 world-aid 去找。
...
### 标题候选
- A：装工具前我先让它多找一圈，上周躲了个坑
- B：搜到的第一个，真不一定是最适合你的
- C：差点装错工具，多亏先看了全貌

### 正文

找现成的小工具，你是不是也是搜一下、挑个排前面的就装？我一直这样，上周差点栽。

我想把个油管视频转成文字，让 world-aid（我自己写的小工具）帮我找。它一下翻出来十几个，还帮我把重样的并掉，剩九个真不一样的。有只下文字的，有顺手截画面的，有自动翻译的，有走 Tor 防封的。

最扎眼那个走 Tor 的听着功能最全，我差点选它。点开才发现是土耳其人给服务器机器人写的，下个字幕要装 Tor、还得动系统，跟我想要的本地工具不是一回事。

要不是把这些都摆出来看，我就盯着那个"功能最全"的装了。后来挑了个低星但顺手的，两分钟搞定。

我的体会是，工具不是搜到第一个就最好。现在我会先让它多找一轮，把重复的并掉，再自己挑，至少不会只看见第一个答案。

world-aid 已经开源，地址：github.com/a28939876-max/world-aid

#AI工具 #效率工具 #开源项目 #程序员日常 #ClaudeCode
